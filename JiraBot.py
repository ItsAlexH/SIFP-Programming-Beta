...
from OrgParse import conversion_excel_date, parse_times, get_color, post_events, get_event_by_search_query, update_events_by_id, Reorganize_Sheet, Verbose_Sheet
Missing_color = 1
...
class SIRA_BOT(commands.Cog):
    ...
    async def events(self, ctx: commands.Context):
        ...
        if task == "Submit Event":
            ...
            payload = {
                "date": date.isoformat(), "start_time": start_t.strftime("%I:%M %p"),
        ...
        if task == "Edit Event":
            ...
            if isinstance(event_to_edit, list):
                if not event_to_edit:
                    ...
                    return
                message_content = "Multiple events found. Which one do you want to edit?\n\n"
            ...
            field_options = {
                ...
                "3": "start_time", "start_time": "start_time", "4": "end_time", "end_time": "end_time",
            ...
            for field in fields_to_edit:
                ...
                if field == "date":
                    ...
                    if new_value: update_args[field] = new_value.isoformat()
                elif field in ["start_time", "end_time"]:
                    new_value = await ask(f"{prompt} (e.g., `9:00 AM`):", parse=parse_time_ampm)
                    if new_value: update_args[field] = new_value.strftime("%I:%M %p")
                else:
